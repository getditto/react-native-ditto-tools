...
- **v5 SDK Support**: Updated peer dependency to `@dittolive/ditto` `>=5.0.1 <6.0.0` (was `>=4.11.4`).
...
- **Example dependencies**: Regenerated the npm and Yarn lockfiles with patched `shell-quote` and `ws` releases for CVE-2026-9277 and CVE-2026-48779.
